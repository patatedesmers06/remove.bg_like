...
export default function ProfilePage() {
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Manage your account settings, monitor billing, and configure API
            access.
          </p>
        </div>
        ...
        <div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <code
                      className="bg-slate-100 px-2 py-1 rounded text-sm font-mono text-slate-600 block truncate"
                      title={user.id}
                    >
                      {user.id}
                    </code>
          ...
          {showCreditModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-sm animate-in fade-in duration-200">
              <div
                className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6 md:p-10 relative animate-in zoom-in-95 duration-200"
              ...
              >
                ...
                <div className="text-center mb-10">
                  ...
                  <p className="text-slate-500 text-lg">
                    Choose a pack that fits your needs. Secure payment via
                    Stripe.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white border-2 border-slate-100 p-6 rounded-2xl hover:border-blue-200 hover:shadow-lg transition-all group relative overflow-hidden flex flex-col items-center text-center">
                    ...
                    <a
                      href="#"
                      className="w-full py-3 rounded-xl bg-slate-100 text-slate-900 font-bold hover:bg-slate-900 hover:text-white transition-colors"
                    >
                      Buy Small
                    </a>
                  </div>
                  ...
                  <div className="bg-white border-2 border-blue-500 p-6 rounded-2xl shadow-xl shadow-blue-500/10 relative overflow-hidden transform md:-translate-y-4 flex flex-col items-center text-center ring-4 ring-blue-500/10">
                    ...
                    <a
                      href="#"
                      className="w-full py-3.5 rounded-xl bg-blue-600 text-white font-bold shadow-lg shadow-blue-500/30 hover:bg-blue-700 transition-colors"
                    >
                      Buy Medium
                    </a>
                  </div>
                ...
                <p className="text-center text-slate-400 text-sm mt-8">
                  Transactions are secure and encrypted. Credits are added
                  immediately.
                </p>
              </div>
            </div>
  ...
  --output result.png`}
                ...
                <div className="mt-4 text-right">
                  <Link
                    href="/docs"
                    className="text-blue-700 font-bold text-sm hover:text-blue-900 transition-colors underline underline-offset-2"
                  >
